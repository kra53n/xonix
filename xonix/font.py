...
class Font:
    ...
    def draw(self, x: int, y: int, s: str, col: int):
        ...
        for c in s:
            ...
            px.blt(x_off + x, y_off + y, self._img, u, v, self._letter_sz, self._letter_sz, self._colkey)
            x_off += self._letter_off
        self._recolor(x, y, x_off + x, y_off + y + self._letter_sz, col)
